...
func (ah *AdHosts) GetChildComputers(ctx context.Context, ccParams ChildComputersParams) (*PxgValStr, []byte, error) {

	postData, _ := json.Marshal(ccParams)
...
//Session to the Administration Server has been closed.
//ChunkAccessor.Release has been called.
func (ah *AdHosts) GetChildOUs(ctx context.Context, cup ChildOUParams) (*PxgValStr,
	[]byte, error) {
...
//TODO Acquire attributes of specified OU.
...
func (ah *AdHosts) GetOU(ctx context.Context, oua OUAttributesParams) (*OUAttributes, []byte, error) {
	postData, _ := json.Marshal(oua)
...
// TODO Updates OU properties.
func (ah *AdHosts) UpdateOU(idOU int, pData interface{}) {
...
type PChunk struct {
	KlcspIteratorArray []KlcspIteratorArray `json:"KLCSP_ITERATOR_ARRAY"`
}

type KlcspIteratorArray struct {
	Type         string       `json:"type"`
	ADHostObject ADHostObject `json:"value"`
}

type ADHostObject struct {
	AdhstAdgroupDistinguishedName string `json:"adhst_adgroup_distinguished_name"`
	AdhstAdgroupID                int64  `json:"adhst_adgroup_id"`
	AdhstAdgroupName              string `json:"adhst_adgroup_name"`
	AdhstAdgroupSamName           string `json:"adhst_adgroup_sam_name"`
}
...
//Session to the Administration Server has been closed.
//ChunkAccessor.Release has been called.
func (ah *AdHosts) FindAdGroups(ctx context.Context, fagP FindAdGroupsParams) (*ADHostIterator, []byte, error) {
	postData, _ := json.Marshal(fagP)
...
//TODO Retrieves AD host attributes.
//
//Parameters:
...
func (ah *AdHosts) GetChildComputer(ctx context.Context, ccp ChildComputerParams) (*AdHstIDParent,
	[]byte, error) {
	postData, _ := json.Marshal(ccp)
